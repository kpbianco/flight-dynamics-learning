# P20 walkthrough: Run a Dispersion Monte Carlo

## Planned learner sequence

1. Read the guiding question: What inputs, observable effects, and failure modes matter when you run a Dispersion Monte Carlo?
