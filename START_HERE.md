...
`./bin/learn start`. P01 is the reference slice; P02 through P09 are the implemented aerospace-frame,
atmosphere-model, point-mass force-trim, longitudinal-static-stability, longitudinal-mode, and
lateral-directional-mode lessons, followed by complete nonlinear rigid-body 6-DOF integration.
