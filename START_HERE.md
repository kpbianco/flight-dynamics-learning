...
`./bin/learn start`. P01 is the reference slice; P02 through P06 are the implemented aerospace-frame,
atmosphere-model, point-mass force-trim, longitudinal-static-stability, and longitudinal-mode lessons.
