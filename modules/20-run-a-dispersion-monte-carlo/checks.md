# P20 checks: Run a Dispersion Monte Carlo
...
- the learner can answer: “What inputs, observable effects, and failure modes matter when you run a Dispersion Monte Carlo?” without relying on MATLAB syntax.
