...
`./bin/learn start`. P01 is the reference slice; P02 through P10 are the implemented aerospace-frame,
...
transparent actuator lag, rate-limit, and position-envelope modeling.
